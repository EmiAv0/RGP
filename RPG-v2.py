...
while running:
    ...
    while (character1.health >= 501 and running):
        print("Please pick a number 1-500.")
    ...
    character2.health = random.randint(1,500)
    ...
    while (character1.health > 0 and character2.health > 0):
        if character1.health >=501:
            character1.health = 250
        if character2.health >= 501:
            character2.health = 250
    
        (character1.attack(character2))
        print(character1.name + " " + random.choice(["assaults", "attacks", "strikes", "charges", "blitzes", "onslaughts", "volleys", "barrages", "bombards",
        ...
        print(character2.name + " " + random.choice(["assaults", "attacks", "strikes", "charges", "blitzes", "onslaughts", "volleys", "barrages", "bombards",
         "shells", "sieges", "pillages", "sacks", "plunders", "pushes", "ambushes", "surprises", "intercepts",
         "clashes", "combats", "battles", "fights", "scuffles", "melees", "brawls", "confronts", "contests", "injures",
         "harms", "wounds", "beats", "pummels", "thrashes", "flogs", "whips", "lashes", "stabs", "pierces", "impales",
         "hacks", "slashes", "cuts", "rips", "tears", "gouges", "scratches", "bites", "stings", "pecks", "claws",
        ...
        if (character1.health >= 0 and character2.health <= 0):
            ...
            if (Y_N == "N") or (Y_N == "n"):
                    running = False
                    print("Thank you for playing RPG!")
                    exit
